...
CONTROL_KEY=""; TIMEOUT=""; GAP=3; LIGHTS="${DORY_LIGHTS:-off}"; LIGHTS_GIVEN=0; FINDLINK=0; PROBE=0; DIAGNOSE=0; IDENTIFY=0; DAEMON=0; SENDCMD=""
...
export DORY_DAEMON="$DAEMON" DORY_SENDCMD="$SENDCMD" DORY_IDENTIFY="$IDENTIFY"
